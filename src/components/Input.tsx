...
export default function (inputProps: CustomInputProps) {
  ...
  const className = `${textStyle} font-bold w-36 sm:w-40 md:w-96 border-0 p-0 focus-visible:outline-0 focus-visible:ring-0 invalid:text-red-500 disabled:opacity-80 transition-all ${inputProps.className}`
